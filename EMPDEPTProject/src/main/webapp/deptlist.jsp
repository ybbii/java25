...
<h1 style="margin-top:20px; font-size:28px;">부서 목록</h1>
<table>
<c:forEach var="dto2" items="${list2}">
	<tr>
	<td><a href="updateForm2?deptno=${dto2.deptno }">${dto2.deptno }</a></td><td>${dto2.dname }</td><td>${dto2.loc }</td><td><button type="button" onclick="location.href='delete2?deptno=${dto2.deptno}' ">삭제</button></td>
	</tr>
</c:forEach>
</table>
<br/><button type="button" onclick="location.href='insertForm2' ">부서등록</button>
</body>
</html>